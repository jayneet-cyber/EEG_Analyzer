          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="text-center">
                <h1 className="tracking-wide" style={{ color: 'var(--text-heading)' }}>NeuroLoad Analyzer</h1>
                <p className="text-sm" style={{ color: 'var(--text-muted)' }}>EEG Cognitive Load Analysis Platform</p>
              </div>
            </div>
            <Button
              onClick={() => window.location.href = '/App.tsx'}
              variant="outline"
              className="px-6 py-2"
            >
